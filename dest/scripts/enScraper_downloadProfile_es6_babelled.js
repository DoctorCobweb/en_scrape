...
var enJobId = casper.cli.get("enJobId");
var enProfId = casper.cli.get("enProfId");
...
var EN_DL_URL = "" + EN + "action.retrievejobresults.do?ea.job.id=" + enJobId + "&jobType=UDX&requestSource=menu";
